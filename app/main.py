...
app.include_router(f24.router,                                               tags=["f24"])
...
app.include_router(quietanze.router,                                         tags=["quietanze"])
app.include_router(alert_fiscali.router,                                     tags=["alert-fiscali"])
app.include_router(tributi.router,           prefix="/api/tributi",         tags=["tributi"])
app.include_router(learning.router,                                          tags=["learning"])
app.include_router(fornitori.router,                                         tags=["fornitori"])
