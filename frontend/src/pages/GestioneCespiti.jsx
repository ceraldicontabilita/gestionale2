        ...
        <TabsContent value="cespiti" style={{ marginTop: 8 }}>
          {riepilogoCespiti && (
            <div style={{ ...styles.grid4, marginBottom: 12 }}>
              <div style={styles.statBox('#eff6ff')}><p style={styles.statLabel('#1535a8')}>Cespiti</p><p style={styles.statValue('#1e40af')}>{riepilogoCespiti.totali.num_cespiti}</p></div>
          ...
          {scadenzario && (
            <>
              <div style={{ ...styles.grid4, marginBottom: 12 }}>
                ...
                <div style={styles.statBox('#eff6ff')}><p style={styles.statLabel('#1535a8')}>Da Pagare</p><p style={styles.statValue('#1e40af')}>{fmt(scadenzario.riepilogo.totale_da_pagare)}</p></div>
