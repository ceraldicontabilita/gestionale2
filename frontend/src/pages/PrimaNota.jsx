      ...
      {activeSection === 'cassa' && (
        <section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: 10, marginBottom: 16 }}>
            <MiniCard title="Entrate (DARE)" value={formatEuro(cassaData.totale_entrate)} color="#15803d" />
          ...
          <div style={{ background: '#f8fafc', borderRadius: 10, padding: 12, marginBottom: 16, border: '1px solid #e2e8f0' }}>
            <details style={{ cursor: 'pointer' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 10, marginTop: 12 }}>
                ...
                <div style={{ background: 'white', borderRadius: 8, padding: 10, borderLeft: '3px solid #15803d' }}>
      ...
      {activeSection === 'banca' && (
        <section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 16, marginBottom: 20 }}>
            <SummaryCard title="Totale Entrate" value={formatEuro(bancaData.totale_entrate)} color="#15803d" icon="📈" subtitle="Accrediti sul conto" />
            <SummaryCard title="Totale Uscite" value={formatEuro(bancaData.totale_uscite)} color="#ef4444" icon="📉" subtitle="Addebiti dal conto" />
            <SummaryCard title="Saldo Periodo" value={formatEuro(bancaData.saldo)} color={bancaData.saldo >= 0 ? '#15803d' : '#ef4444'} icon="💰" highlight />
          </div>
          ...
          <div style={{ display: 'flex', gap: 6, alignItems: 'center', marginBottom: 16, flexWrap: 'wrap' }}>
            ...
            <button 
              ...
              style={{ 
                padding: '8px 14px', 
                background: selectedMonth === null ? '#1535a8' : '#f3f4f6', 
                color: selectedMonth === null ? 'white' : '#374151', 
                border: 'none', 
                borderRadius: 8, 
                cursor: 'pointer', 
            ...
            {mesiNomi.map((nome, i) => (
              <button 
                ...
                style={{ 
                  padding: '8px 12px', 
                  background: selectedMonth === i ? '#1535a8' : '#f3f4f6', 
                  color: selectedMonth === i ? 'white' : '#374151', 
                  border: 'none', 
                  borderRadius: 8, 
                  cursor: 'pointer', 
                ...
                {!readOnly && (
                  <td style={{ padding: '6px 8px', textAlign: 'center', whiteSpace: 'nowrap' }}>
                    <button 
                      ...
                      style={{ 
                        background: tipo === 'cassa' ? '#1535a8' : '#7c3aed', 
                        color: 'white',
                        border: 'none', 
                        borderRadius: 4,
                        padding: '3px 6px',
