...
const STATUS_LABELS = {
  nuovo: { label: 'Nuovo', color: '#1535a8', bg: '#dbeafe' },
                      ...
                      {customKeywords.map(kw => (
                        <div 
                          ...
                          style={{ 
                            ...
                            borderRadius: 8,
                            border: paroleChiaveSelezionate.includes(kw.id) ? '2px solid #15803d' : '1px solid #e2e8f0'
                          }}
                        >
                          <button
                            onClick={() => toggleKeyword(kw.id)}
                            style={{
                              ...
                              background: paroleChiaveSelezionate.includes(kw.id) ? '#15803d' : 'white',
                              color: paroleChiaveSelezionate.includes(kw.id) ? 'white' : '#15803d',
                              cursor: 'pointer',
                              fontSize: 12,
                              display: 'flex',
                              alignItems: 'center',
      ...
      <div style={{ display: 'flex', gap: 16, marginBottom: 20, flexWrap: 'wrap' }}>
        ...
        {stats?.by_category?.map(cat => (
          ...
          >
            ...
            {cat.nuovi > 0 && <span style={{ marginLeft: 4, color: '#1535a8' }}>({cat.nuovi} nuovi)</span>}
          </div>
        ))}
      </div>
